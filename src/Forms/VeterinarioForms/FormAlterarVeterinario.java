 ...
 * @author jadil
 */
public class FormAlterarVeterinario extends javax.swing.JFrame {
    ...
    private void jButtonBUSCARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBUSCARActionPerformed
        ...
        try {
            Veterinario filtro = new Veterinario();

            VeterinarioDado dados = new VeterinarioDado();
            this.listaVeterinarios = dados.listar(filtro);
            DefaultTableModel modelo = new DefaultTableModel();
            modelo.setColumnIdentifiers(new Object[]{"CODIGO","CRMV","MATRICULA", "NOME", "CPF",  "EMAIL","NASCIMENTO", "TELEFONE"});
            for (Veterinario veterinario : this.listaVeterinarios) {

                DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
                Date date = (Date) veterinario.getDataDeNascimento();
                String s = df.format(date);

                modelo.addRow(new Object[]{veterinario.getID(),veterinario.getCrmv(), veterinario.getMatricula(), veterinario.getNome(),veterinario.getCpf(),veterinario.getEmail(), veterinario.getDataDeNascimento(), veterinario.getTelefone()});
            }
    ...
    private void jButtonEXCLUIRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEXCLUIRActionPerformed
        ...
        try {
            ...
            v.setID(Integer.parseInt(jTextFieldCODIGO.getText()));

            VeterinarioDado negocio = new VeterinarioDado();
            negocio.DeletarVeterinario(v);
            JOptionPane.showMessageDialog(this, "Veterinário excluido");
    ...
    private void jTableLISTARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableLISTARMouseClicked
        ...
        Veterinario vet = this.listaVeterinarios.get(linha);
        
           DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
                Date date = (Date) vet.getDataDeNascimento();
                String s = df.format(date);
        ...
        jFormattedTextFieldCPF.setText(vet.getCpf());
        jFormattedTextFieldDATA.setText(s);
        TxtEmail.setText(vet.getEmail());
        TxtMatricula.setText(vet.getMatricula());
    ...
    private void jButtonALTERARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonALTERARActionPerformed
        ...
        try {
            ...
            negocio.atualizarVeterinario(v);
            JOptionPane.showMessageDialog(this, "Veterinário alterado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAlterarVeterinario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAlterarVeterinario().setVisible(true);
            }
        });
    }
