    ...
    private void jButtonLISTARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLISTARActionPerformed
        // TODO add your handling code here:
         ...
         try {
            ...
            modelo.setColumnIdentifiers(new Object[]{"CODIGO","MATRICULA","NOME","CPF","TELEFONE","NASCIMENTO","E-MAIL"});
            for (Funcionario funcionario : lista) {
                modelo.addRow(new Object[]{funcionario.getID(),funcionario.getMatricula(),funcionario.getNome(),funcionario.getCpf(),funcionario.getTelefone(),funcionario.getDataDeNascimento(),funcionario.getEmail()});
            }
